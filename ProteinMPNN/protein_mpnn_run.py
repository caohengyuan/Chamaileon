...
if __name__ == "__main__":
    ...
    argparser.add_argument("--save_logits", type=int, default=0, help="0 for False, 1 for True; save logits before sampling")
    argparser.add_argument("--logits_folder", type=str, default='', help="Path to folder to save logits")
