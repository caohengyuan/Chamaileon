...
def get_dataset_cfg(cfg):
    if cfg.data.dataset == 'pdb_target_binder':
        return cfg.pdb_target_binder_dataset
    elif cfg.data.dataset == 'pdb_multi_target_binder':
        return cfg.pdb_multi_target_binder_dataset
    else:
